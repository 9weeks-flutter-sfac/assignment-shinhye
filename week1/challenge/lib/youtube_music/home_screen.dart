      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: MusicTile(
              img: 'assets/music_you_make_me.png',
              title: 'You Make Me',
              artist: 'DAY6',
              duration: '3:00',
              isPlaying: true,
...
class MusicList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        MusicTile(
          img: 'assets/music_come_with_me.png',
          title: 'Come with me',
        ...
        MusicTile(
          img: 'assets/music_honesty.png',
          title: 'Honesty',
          artist: 'Pink Sweat\$',
          duration: '3:09',
        ),
        MusicTile(
          img: 'assets/music_i_wish_i_missed_my_ex.png',
          title: 'I Wish I Missed My Ex',
          artist: '마할리아 버크마',
          duration: '3:24',
        ),
        MusicTile(
          img: 'assets/music_plastic_plants.png',
          title: 'Plastic Plants',
          artist: '마할리아 버크마',
          duration: '3:20',
        ),
        MusicTile(
          img: 'assets/music_sucker_for_you.png',
          title: 'Sucker for you',
          artist: '맷 테리',
          duration: '3:24',
        ),
        MusicTile(
          img: 'assets/music_summer_is_for_falling_in_love.png',
        ...
        MusicTile(
          img: 'assets/music_zombie_pop.png',
          title: 'Zombie Pop',
          artist: 'DRP IAN',
          duration: '3:00',
        ),
